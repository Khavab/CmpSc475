...
struct EasyButtonView: View {
    ...
    var body: some View {
        ...
        ZStack {
            EasyButton(addLetter: addLetter, cent: false, spellLetter: centeredLetters[0])
                .offset(x: -60, y: -60)
            EasyButton(addLetter: addLetter, cent: false, spellLetter: centeredLetters[1])
                .offset(x: 60, y: -60)
            EasyButton(addLetter: addLetter, cent: true, spellLetter: centeredLetters[2])
            EasyButton(addLetter: addLetter, cent: false, spellLetter: centeredLetters[3])
                .offset(x: -60, y: 60)
            EasyButton(addLetter: addLetter, cent: false, spellLetter: centeredLetters[4])
                .offset(x: 60, y: 60)
        }
